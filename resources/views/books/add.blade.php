    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Books Add Data</h3>
            ...
            <div class="card-body">
                <form role="form" method="POST" action="/books/create" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="form-group">
                            <label>Book Code</label>
                            <input type="text" name="book_code" class="form-control" placeholder="Enter Book Code" value="{{ old('book_code') }}">
